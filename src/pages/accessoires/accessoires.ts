...
import { DetailAccessoirePage } from '../detail-accessoire/detail-accessoire';
import { Data3 } from './accessoires.service';

@IonicPage()
@Component({
  selector: 'page-accessoires',
  templateUrl: 'accessoires.html',
})
export class AccessoiresPage {
  articles: product[];  //tableau d'objets
  searchTerm : any="";
  jsonData : any;
  constructor(public navCtrl: NavController, public navParams: NavParams ,public http: Http,
    public imageViewer:ImageViewerController,public method:MethodProvider,public data:Data3) {
  ...
  showDetails(article:product):void{
    this.navCtrl.push(DetailAccessoirePage,{data:article});
      }
